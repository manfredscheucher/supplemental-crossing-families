...
"""
	...
	to verify that every set of n points contains a 3-crossing family
...
for I in combinations(N,6):
	for a1,a2,a3 in combinations(I,3):
		J = [i for i in I if i not in {a1,a2,a3}]
		for b1,b2,b3 in permutations(J):
			if a1<b1 and a2<b2 and a3<b3:
				segments = [(a1,b1),(a2,b2),(a3,b3)]
