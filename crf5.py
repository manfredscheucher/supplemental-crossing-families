...
"""
	...
	to verify that every set of n points contains a 5-crossing family
...
for I in combinations(N,10):
	for a1,a2,a3,a4,a5 in combinations(I,5):
		J = [i for i in I if i not in {a1,a2,a3,a4,a5}]
		for b1,b2,b3,b4,b5 in permutations(J):
			if a1<b1 and a2<b2 and a3<b3 and a4<b4 and a5<b5:
				segments = [(a1,b1),(a2,b2),(a3,b3),(a4,b4),(a5,b5)]
